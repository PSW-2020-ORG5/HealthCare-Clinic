...
namespace Health_Clinic_Integration.Services.RabbitMqService
{
    public class RabbitMqActionBenefitService : BackgroundService
    {
        ...
        private MyActionBenefitContext _context;
        ...
        private void ConnectToDb()
        {
            ...
            DbContextOptionsBuilder<MyActionBenefitContext> builder = new DbContextOptionsBuilder<MyActionBenefitContext>();

            builder.UseMySql(ConfigurationDto.GetInstance().myDbConnectionString)
                    .UseInternalServiceProvider(serviceProvider); //ovde puca

            _context = new MyActionBenefitContext(builder.Options);
