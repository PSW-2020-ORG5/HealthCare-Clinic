...
namespace IntegrationAdaptersTests.UnitTests
{
    public class ApiKeyTests
    {
        ...
        public void Find_all_api_keys()
        {
            ...
            mockDBContext.Setup(t => t.GetApis()).Returns(new List<ApiKey> { new ApiKey() { api_key = "key1", name = "name1" },
                                                                           new ApiKey() { api_key = "key2", name = "name2" }
                                                                         });
        ...
        public void Save_key_without_name()
        {
            ...
            ApiKeyServiceTest service = new ApiKeyServiceTest();
            service.SaveKey(mockDBContext.Object, new ApiKey() { api_key = "key", name = "" }).ShouldBe(2);
        }
        ...
        public void Save_key_with_name()
        {
            ...
            ApiKeyServiceTest service = new ApiKeyServiceTest();
            service.SaveKey(mockDBContext.Object, new ApiKey() { api_key = "key", name = "Danilo" }).ShouldBe(3);
        }
